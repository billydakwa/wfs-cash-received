...
Class ListPage_Lookup
	...
	Public lookupTable
	Public lookupParams
	Public lookupSelectField
	Public customField
	Public dispField
	Public mainTable
	Public mainField
	Public dispFieldAlias
	Public lookupValuesArr
	...
	Public Function init_ListPage_Lookup_p1(ByRef params)
		DoAssignmentByRef init_ListPage_Lookup_p1,method_ListPage_Lookup_ListPage_Lookup(me,params)
	End Function
	Public Function initLookupParams()
		DoAssignmentByRef initLookupParams,method_ListPage_Lookup_initLookupParams(me)
	End Function
	Public Function clearLookupSessionData()
		DoAssignmentByRef clearLookupSessionData,method_ListPage_Lookup_clearLookupSessionData(me)
	End Function
	Public Function addCommonHtml()
		DoAssignmentByRef addCommonHtml,method_ListPage_Lookup_addCommonHtml(me)
	End Function
	Public Function addCommonJs()
		DoAssignmentByRef addCommonJs,method_ListPage_Lookup_addCommonJs(me)
	End Function
	Public Function setLinksAttr_p2(ByVal field,ByVal sort)
		DoAssignmentByRef setLinksAttr_p2,method_ListPage_Lookup_setLinksAttr(me,field,sort)
	End Function
	Public Function setLinksAttr_p1(ByVal field)
		DoAssignmentByRef setLinksAttr_p1,method_ListPage_Lookup_setLinksAttr(me,field,"")
	End Function
	Public Function addSpanVal_p2(ByVal fName,ByRef data)
		DoAssignmentByRef addSpanVal_p2,method_ListPage_Lookup_addSpanVal(me,fName,data)
	End Function
	Public Function buildLookupWhereClause()
		DoAssignmentByRef buildLookupWhereClause,method_ListPage_Lookup_buildLookupWhereClause(me)
	End Function
	Public Function buildSQL()
		DoAssignmentByRef buildSQL,method_ListPage_Lookup_buildSQL(me)
	End Function
	Public Function buildSearchPanel()
		DoAssignmentByRef buildSearchPanel,method_ListPage_Lookup_buildSearchPanel(me)
	End Function
	Public Function displayAfterLoadTempl()
		DoAssignmentByRef displayAfterLoadTempl,method_ListPage_Lookup_displayAfterLoadTempl(me)
	End Function
	Public Function countWidthListIcons_p1(ByVal row)
		DoAssignmentByRef countWidthListIcons_p1,method_ListPage_Lookup_countWidthListIcons(me,row)
	End Function
	Public Function addLookupVals()
		DoAssignmentByRef addLookupVals,method_ListPage_Lookup_addLookupVals(me)
	End Function
	Public Function prepareForBuildPage()
		DoAssignmentByRef prepareForBuildPage,method_ListPage_Lookup_prepareForBuildPage(me)
	End Function
	Public Function fillCheckAttr_p3(ByRef record,ByVal data,ByVal keyblock)
		DoAssignmentByRef fillCheckAttr_p3,method_ListPage_Lookup_fillCheckAttr(me,record,data,keyblock)
	End Function
	Public Function addSpansForGridCells_p2(ByRef record,ByRef data)
		DoAssignmentByRef addSpansForGridCells_p2,method_ListPage_Lookup_addSpansForGridCells(me,record,data)
	End Function
	Public Function proccessRecordValue_p3(ByRef data,ByRef keylink,ByVal listFieldInfo)
		DoAssignmentByRef proccessRecordValue_p3,method_ListPage_Lookup_proccessRecordValue(me,data,keylink,listFieldInfo)
	End Function
	Public Function showPage()
		DoAssignmentByRef showPage,method_ListPage_Lookup_showPage(me)
	End Function
	Public Function buildTotals_p1(ByRef totals)
		DoAssignmentByRef buildTotals_p1,method_ListPage_Lookup_buildTotals(me,totals)
	End Function
	Public Function commonAssign()
		DoAssignmentByRef commonAssign,method_ListPage_Embed_commonAssign(me)
	End Function
	Public Function addWhereWithMasterTable()
		DoAssignmentByRef addWhereWithMasterTable,method_ListPage_Embed_addWhereWithMasterTable(me)
	End Function
...
' serialize stuff
	Public Function ASPserialize
		...
		setArrElement out,"strLookupWhere", strLookupWhere
		setArrElement out,"categoryField", categoryField
		setArrElement out,"linkField", linkField
		setArrElement out,"parId", parId
		setArrElement out,"lookupField", lookupField
		setArrElement out,"lookupControl", lookupControl
		setArrElement out,"lookupCategory", lookupCategory
		setArrElement out,"lookupTable", lookupTable
		setArrElement out,"lookupParams", lookupParams
		setArrElement out,"lookupSelectField", lookupSelectField
		setArrElement out,"customField", customField
		setArrElement out,"dispField", dispField
		setArrElement out,"mainTable", mainTable
		setArrElement out,"mainField", mainField
		setArrElement out,"dispFieldAlias", dispFieldAlias
		setArrElement out,"lookupValuesArr", lookupValuesArr
		setArrElement out,"masterPageType", masterPageType
		setArrElement out,"mainMasterPageType", mainMasterPageType
		setArrElement out,"viewPDF", viewPDF
	...
	Public Sub ASPunserialize(dict)
		DoAssignment strLookupWhere, dict("strLookupWhere")
		DoAssignment categoryField, dict("categoryField")
		DoAssignment linkField, dict("linkField")
		DoAssignment parId, dict("parId")
		DoAssignment lookupField, dict("lookupField")
		DoAssignment lookupControl, dict("lookupControl")
		DoAssignment lookupCategory, dict("lookupCategory")
		DoAssignment lookupTable, dict("lookupTable")
		DoAssignment lookupParams, dict("lookupParams")
		DoAssignment lookupSelectField, dict("lookupSelectField")
		DoAssignment customField, dict("customField")
		DoAssignment dispField, dict("dispField")
		DoAssignment mainTable, dict("mainTable")
		DoAssignment mainField, dict("mainField")
		DoAssignment dispFieldAlias, dict("dispFieldAlias")
		DoAssignment lookupValuesArr, dict("lookupValuesArr")
		DoAssignment masterPageType, dict("masterPageType")
		DoAssignment mainMasterPageType, dict("mainMasterPageType")
		DoAssignment viewPDF, dict("viewPDF")
...
' end serialize
End Class
' ListPage_Lookup implementation 
Function method_ListPage_Lookup_ListPage_Lookup(byref this_object,ByRef params)
	this_object.strLookupWhere = ""
	this_object.categoryField = ""
	this_object.linkField = ""
	this_object.parId = 0
	this_object.lookupField = ""
	this_object.lookupControl = ""
	this_object.lookupCategory = ""
	this_object.lookupTable = ""
	this_object.lookupParams = ""
	this_object.lookupSelectField = ""
	this_object.customField = ""
	this_object.dispField = ""
	this_object.mainTable = ""
	this_object.mainField = ""
	this_object.dispFieldAlias = ""
	doClassAssignment this_object,"lookupValuesArr",CreateDictionary()
	this_object.masterPageType = ""
	this_object.mainMasterPageType = ""
	this_object.viewPDF = 0
	...
	this_object.initLookupParams 
	method_ListPage_Embed_ListPage_Embed this_object,params
	this_object.isUseAjaxSuggest = false
End Function
Function method_ListPage_Lookup_initLookupParams(byref this_object)
	Dim this
	doClassAssignment this_object,"parId",postvalue("parId")
	doClassAssignment this_object,"firstTime",postvalue("firsttime")
	doClassAssignment this_object,"mainField",postvalue("field")
	doClassAssignment this_object,"lookupControl",postvalue("control")
	doClassAssignment this_object,"lookupCategory",postvalue("category")
	doClassAssignment this_object,"mainTable",postvalue("table")
	asp_include getabspath(("include/" & CSmartStr(GetTableURL(this_object.mainTable))) & "_settings.asp"),true
	this_object.lookupParams = (((((((((((("mode=lookup&id=" & CSmartStr(this_object.id)) & "&parId=") & CSmartStr(this_object.parId)) & "&field=") & CSmartStr(asp_rawurlencode(this_object.mainField))) & "&control=") & CSmartStr(asp_rawurlencode(this_object.lookupControl))) & "&category=") & CSmartStr(asp_rawurlencode(this_object.lookupCategory))) & "&table=") & CSmartStr(asp_rawurlencode(this_object.mainTable))) & "&editMode=") & CSmartStr(postvalue("editMode"))
	this_object.sessionPrefix = (((CSmartStr(this_object.tName) & "_lookup_") & CSmartStr(this_object.mainTable)) & "_") & CSmartStr(this_object.mainField)
	doClassAssignment this_object,"linkField",GetLWLinkField(this_object.mainField,this_object.mainTable,false)
	doClassAssignment this_object,"dispField",GetLWDisplayField(this_object.mainField,this_object.mainTable,false)
	if bValue(GetFieldData(this_object.mainTable,this_object.mainField,"CustomDisplay",false)) then
		doClassAssignment this_object,"customField",this_object.linkField
		this_object.dispFieldAlias = "dispField1"
	end if
	this_object.outputFieldValue_p2 this_object.linkField,2
	this_object.outputFieldValue_p2 this_object.dispField,2
	if bValue(UseCategory(this_object.mainField,this_object.mainTable)) then
		doClassAssignment this_object,"categoryField",GetFieldData(this_object.mainTable,this_object.mainField,"CategoryFilter","")
	end if
	doClassAssignment this_object,"strLookupWhere",LookupWhere(this_object.mainField,this_object.mainTable)
	if bValue(this_object.dispFieldAlias) and bValue(AppearOnListPage(this_object.dispField,"")) then
		doClassAssignment this_object,"lookupSelectField",this_object.linkField
	else
		if bValue(AppearOnListPage(this_object.dispField,"")) then
			doClassAssignment this_object,"lookupSelectField",this_object.dispField
		else
			doClassAssignment this_object,"lookupSelectField",ArrayElement(ArrayElement(this_object.listFields,0),"fName")
		end if
	end if
	if bValue(this_object.categoryField) then
		if not bValue(asp_strlen(GetFullFieldName(this_object.categoryField,""))) then
			this_object.categoryField = ""
		end if
	end if
	if not bValue(this_object.categoryField) then
		this_object.lookupCategory = ""
	end if
End Function
Function method_ListPage_Lookup_clearLookupSessionData(byref this_object)
	Dim sessLookUpUnset,var_SESSION,key
	if bValue(this_object.firstTime) then
		Set sessLookUpUnset = (CreateDictionary())
		GetCollectionBounds Session,c_listpage_lookup_loopIdx2,c_listpage_lookup_loopMax2
		do while c_listpage_lookup_loopIdx2<=c_listpage_lookup_loopMax2
			key = GetCollectionKey(Session,c_listpage_lookup_loopIdx2)
			doAssignment value,Session(key)
			if not IsFalse(asp_strpos(key,"_lookup_",empty)) then
				setArrElement sessLookUpUnset,asp_count(sessLookUpUnset),key
			end if
			c_listpage_lookup_loopIdx2=c_listpage_lookup_loopIdx2+1
		loop
		GetCollectionBounds sessLookUpUnset,c_listpage_lookup_loopIdx3,c_listpage_lookup_loopMax3
		do while c_listpage_lookup_loopIdx3<=c_listpage_lookup_loopMax3
			c_listpage_lookup_arrKey3 = GetCollectionKey(sessLookUpUnset,c_listpage_lookup_loopIdx3)
			doAssignment key,ArrayElement(sessLookUpUnset,c_listpage_lookup_arrKey3)
			asp_unsetElement Session,key
			c_listpage_lookup_loopIdx3=c_listpage_lookup_loopIdx3+1
		loop
	end if
End Function
Function method_ListPage_Lookup_addCommonHtml(byref this_object)
	method_ListPage_Embed_addCommonHtml this_object
End Function
Function method_ListPage_Lookup_addCommonJs(byref this_object)
	Dim fieldAsDisplay
	doAssignment fieldAsDisplay,this_object.dispField
	if bValue(this_object.customField) then
		doAssignment fieldAsDisplay,this_object.lookupSelectField
	end if
	setArrElement this_object.controlsMap,"lookupSelectField",this_object.lookupSelectField
	setArrElement this_object.controlsMap,"dispFieldAlias",this_object.dispFieldAlias
	setArrElement this_object.controlsMap,"linkField",this_object.linkField
	setArrElement this_object.controlsMap,"dispField",this_object.dispField
End Function
Function method_ListPage_Lookup_setLinksAttr(byref this_object,ByVal field,ByVal sort)
	Dim href,orderlinkattrs
	href = ((((CSmartStr(this_object.shortTableName) & "_list.asp?orderby=") & CSmartStr(IIF(not IsEqual(sort,""),IIF(IsEqual(sort,"a"),"d","a"),"a"))) & CSmartStr(field)) & "&") & CSmartStr(this_object.lookupParams)
	...
	doAssignmentByRef method_ListPage_Lookup_setLinksAttr,orderlinkattrs
	Exit Function
End Function
Function method_ListPage_Lookup_addSpanVal(byref this_object,ByVal fName,ByRef data)
	if bValue(this_object.dispFieldAlias) and IsEqual(ArrayElement(this_object.arrFieldSpanVal,fName),2) then
		method_ListPage_Lookup_addSpanVal = ("val=""" & CSmartStr(htmlspecialchars(ArrayElement(data,this_object.dispFieldAlias)))) & """ "
		Exit Function
	else
		doAssignmentByRef method_ListPage_Lookup_addSpanVal,method_ListPage_addSpanVal(this_object,fName,data)
		Exit Function
	end if
End Function
Function method_ListPage_Lookup_buildLookupWhereClause(byref this_object)
	if bValue(asp_strlen(this_object.lookupCategory)) then
		doClassAssignment this_object,"strWhereClause",whereAdd(this_object.strWhereClause,(CSmartStr(GetFullFieldName(this_object.categoryField,"")) & "=") & CSmartStr(make_db_value(this_object.categoryField,this_object.lookupCategory,"","","")))
	end if
	if bValue(asp_strlen(this_object.strLookupWhere)) then
		doClassAssignment this_object,"strWhereClause",whereAdd(this_object.strWhereClause,this_object.strLookupWhere)
	end if
	if (bValue(UseCategory(this_object.mainField,this_object.mainTable)) and not IsEqual(postvalue("editMode"),MODE_SEARCH)) and not bValue(asp_strlen(this_object.lookupCategory)) then
		doClassAssignment this_object,"strWhereClause",whereAdd(this_object.strWhereClause,"1=0")
	end if
End Function
Function method_ListPage_Lookup_buildSQL(byref this_object)
	Dim this
	this_object.buildLookupWhereClause 
	if bValue(this_object.dispFieldAlias) then
		this_object.gsqlHead = CSmartStr(this_object.gsqlHead) & ((", " & CSmartStr(this_object.dispField)) & " ")
		this_object.gsqlHead = CSmartStr(this_object.gsqlHead) & (("as " & CSmartStr(AddFieldWrappers(this_object.dispFieldAlias))) & " ")
	end if
	method_ListPage_buildSQL this_object
End Function
Function method_ListPage_Lookup_buildSearchPanel(byref this_object)
	Dim params,this
	...
	doClassAssignment this_object,"searchPanel",CreateClass("SearchPanelLookup",1,params,Empty,Empty,Empty,Empty,Empty,Empty)
	this_object.searchPanel.buildSearchPanel 
End Function
Function method_ListPage_Lookup_displayAfterLoadTempl(byref this_object)
	Dim lookupSearchControls,this,returnJSON
	lookupSearchControls = (CSmartStr(this_object.xt.fetch_loaded_p1("searchform_text")) & CSmartStr(this_object.xt.fetch_loaded_p1("searchform_search"))) & CSmartStr(this_object.xt.fetch_loaded_p1("searchform_showall"))
	this_object.xt.assign_p2 "lookupSearchControls",lookupSearchControls
	this_object.fillSetCntrlMaps 
	setArrElement returnJSON,"controlsMap",this_object.controlsHTMLMap
	setArrElement returnJSON,"settings",this_object.jsSettings
	this_object.xt.assign_p2 "header",false
	this_object.xt.assign_p2 "footer",false
	setArrElement returnJSON,"html",CSmartStr(method_ListPage_Embed_displayAfterLoadTempl(this_object)) & CSmartStr(this_object.xt.fetch_loaded_p1("body"))
	setArrElement returnJSON,"idStartFrom",this_object.flyId
	setArrElement returnJSON,"success",true
	ResponseWrite my_json_encode(returnJSON)
End Function
Function method_ListPage_Lookup_countWidthListIcons(byref this_object,ByVal row)
	Exit Function
End Function
Function method_ListPage_Lookup_addLookupVals(byref this_object)
	setArrElement this_object.controlsMap,"lookupVals",this_object.lookupValuesArr
End Function
Function method_ListPage_Lookup_prepareForBuildPage(byref this_object)
	Dim this
	this_object.buildOrderParams 
	this_object.deleteRecords 
	this_object.buildSearchPanel 
	...
	this_object.addLookupVals 
	this_object.addCommonJs 
	this_object.addCommonHtml 
	this_object.commonAssign 
End Function
Function method_ListPage_Lookup_fillCheckAttr(byref this_object,ByRef record,ByVal data,ByVal keyblock)
	Dim checkbox_attrs
	checkbox_attrs = ((("name=""selection[]"" value=""" & CSmartStr(htmlspecialchars(ArrayElement(data,this_object.linkField)))) & """ id=""check") & CSmartStr(this_object.recId)) & """"
	setArrElement record,"checkbox",CreateDictionary2("begin",("<input type='checkbox' " & CSmartStr(checkbox_attrs)) & ">","data",CreateDictionary())
End Function
Function method_ListPage_Lookup_addSpansForGridCells(byref this_object,ByRef record,ByRef data)
	Dim dispVal
	if bValue(this_object.dispFieldAlias) then
		doAssignment dispVal,ArrayElement(data,this_object.dispFieldAlias)
	else
		doAssignment dispVal,ArrayElement(data,this_object.dispField)
	end if
	setArrElement this_object.lookupValuesArr,asp_count(this_object.lookupValuesArr),CreateDictionary2("linkVal",ArrayElement(data,this_object.linkField),"dispVal",dispVal)
End Function
Function method_ListPage_Lookup_proccessRecordValue(byref this_object,ByRef data,ByRef keylink,ByVal listFieldInfo)
	Dim value
	if bValue(NeedEncode(ArrayElement(listFieldInfo,"fName"),this_object.tName)) and IsEqual(this_object.customField,ArrayElement(listFieldInfo,"fName")) then
		doAssignmentByRef value,ProcessLargeText(GetData(data,this_object.linkField,ArrayElement(listFieldInfo,"viewFormat")),("field=" & CSmartStr(asp_rawurlencode(ArrayElement(listFieldInfo,"fName")))) & CSmartStr(keylink),"",MODE_LIST,"")
	else
		doAssignmentByRef value,method_ListPage_proccessRecordValue(this_object,data,keylink,listFieldInfo)
	end if
	if IsEqual(this_object.lookupSelectField,ArrayElement(listFieldInfo,"fName")) then
		value = ((("<a href=""#"" type=""lookupSelect" & CSmartStr(this_object.id)) & """>") & CSmartStr(value)) & "</a>"
	end if
	doAssignmentByRef method_ListPage_Lookup_proccessRecordValue,value
	Exit Function
End Function
Function method_ListPage_Lookup_showPage(byref this_object)
	Dim this
	this_object.BeforeShowList 
	this_object.xt.load_template_p1 this_object.templatefile
	this_object.displayAfterLoadTempl 
End Function
Function method_ListPage_Lookup_buildTotals(byref this_object,ByRef totals)
End Function
%>
