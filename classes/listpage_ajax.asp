...
Class ListPage_Ajax
	...
	Public Function init_ListPage_Ajax_p1(ByRef params)
		DoAssignmentByRef init_ListPage_Ajax_p1,method_ListPage_Ajax_ListPage_Ajax(me,params)
	End Function
	Public Function commonAssign()
		DoAssignmentByRef commonAssign,method_ListPage_Ajax_commonAssign(me)
	End Function
	Public Function addCommonHtml()
		DoAssignmentByRef addCommonHtml,method_ListPage_Ajax_addCommonHtml(me)
	End Function
	Public Function addCommonJs()
		DoAssignmentByRef addCommonJs,method_ListPage_Ajax_addCommonJs(me)
	End Function
	Public Function prepareForBuildPage()
		DoAssignmentByRef prepareForBuildPage,method_ListPage_Ajax_prepareForBuildPage(me)
	End Function
	Public Function showPage()
		DoAssignmentByRef showPage,method_ListPage_Ajax_showPage(me)
	End Function
...
' end serialize
End Class
' ListPage_Ajax implementation 
Function method_ListPage_Ajax_ListPage_Ajax(byref this_object,ByRef params)
...
End Function
Function method_ListPage_Ajax_commonAssign(byref this_object)
	Dim searchPermis,this
	...
	if bValue(this_object.isDispGrid()) then
		this_object.xt.assign_section_p3 "grid_block","",""
	end if
End Function
Function method_ListPage_Ajax_addCommonHtml(byref this_object)
	method_ListPage_Ajax_addCommonHtml = true
	Exit Function
End Function
Function method_ListPage_Ajax_addCommonJs(byref this_object)
	Dim this
	this_object.addJsForGrid 
End Function
Function method_ListPage_Ajax_prepareForBuildPage(byref this_object)
	Dim this
...
End Function
Function method_ListPage_Ajax_showPage(byref this_object)
	Dim this,returnJSON
	this_object.BeforeShowList 
	this_object.xt.load_template_p1 this_object.templatefile
	Set returnJSON = (CreateDictionary3("success",true,"html",CreateDictionary(),"idStartFrom",this_object.flyId))
	...
	setArrElementN returnJSON,CreateArray2("html","details"),this_object.xt.fetch_loaded_p1("details_block")
	setArrElementN returnJSON,CreateArray2("html","pages"),this_object.xt.fetch_loaded_p1("pages_block")
	setArrElementN returnJSON,CreateArray2("html","grid"),this_object.xt.fetch_loaded_p1("grid_block")
	setArrElementN returnJSON,CreateArray2("html","pagination"),this_object.xt.fetch_loaded_p1("pagination_block")
	setArrElementN returnJSON,CreateArray2("html","message"),this_object.xt.fetch_loaded_p1("message_block")
