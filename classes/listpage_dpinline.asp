...
Class ListPage_DPInline
	Public dpParams
	Public dpMasterKey
	Public masterShortTable
	Public masterFormName
	Public masterId
	...
	Public Function init_ListPage_DPInline_p1(ByRef params)
		DoAssignmentByRef init_ListPage_DPInline_p1,method_ListPage_DPInline_ListPage_DPInline(me,params)
	End Function
	Public Function initForDetailsPreview()
		DoAssignmentByRef initForDetailsPreview,method_ListPage_DPInline_initForDetailsPreview(me)
	End Function
	Public Function addButtonHandlers()
		DoAssignmentByRef addButtonHandlers,method_ListPage_DPInline_addButtonHandlers(me)
	End Function
	Public Function importLinksAttrs()
		DoAssignmentByRef importLinksAttrs,method_ListPage_DPInline_importLinksAttrs(me)
	End Function
	Public Function displayMasterTableInfo()
		DoAssignmentByRef displayMasterTableInfo,method_ListPage_DPInline_displayMasterTableInfo(me)
	End Function
	Public Function processMasterKeyValue()
		DoAssignmentByRef processMasterKeyValue,method_ListPage_DPInline_processMasterKeyValue(me)
	End Function
	Public Function initDPInlineParams()
		DoAssignmentByRef initDPInlineParams,method_ListPage_DPInline_initDPInlineParams(me)
	End Function
	Public Function getStrMasterKey()
		DoAssignmentByRef getStrMasterKey,method_ListPage_DPInline_getStrMasterKey(me)
	End Function
	Public Function setLinksAttr_p2(ByVal field,ByVal sort)
		DoAssignmentByRef setLinksAttr_p2,method_ListPage_DPInline_setLinksAttr(me,field,sort)
	End Function
	Public Function setLinksAttr_p1(ByVal field)
		DoAssignmentByRef setLinksAttr_p1,method_ListPage_DPInline_setLinksAttr(me,field,"")
	End Function
	Public Function getLocation_p2(ByVal href,ByVal ret)
		DoAssignmentByRef getLocation_p2,method_ListPage_DPInline_getLocation(me,href,ret)
	End Function
	Public Function getLocation_p1(ByVal href)
		DoAssignmentByRef getLocation_p1,method_ListPage_DPInline_getLocation(me,href,true)
	End Function
	Public Function inlineAddLinksAttrs()
		DoAssignmentByRef inlineAddLinksAttrs,method_ListPage_DPInline_inlineAddLinksAttrs(me)
	End Function
	Public Function commonAssign()
		DoAssignmentByRef commonAssign,method_ListPage_DPInline_commonAssign(me)
	End Function
	Public Function deleteSelectedAttrs()
		DoAssignmentByRef deleteSelectedAttrs,method_ListPage_DPInline_deleteSelectedAttrs(me)
	End Function
	Public Function displayAfterLoadTempl()
		DoAssignmentByRef displayAfterLoadTempl,method_ListPage_DPInline_displayAfterLoadTempl(me)
	End Function
	Public Function prepareForBuildPage()
		DoAssignmentByRef prepareForBuildPage,method_ListPage_DPInline_prepareForBuildPage(me)
	End Function
	Public Function addLoadedContentDiv_p1(ByVal close)
		DoAssignmentByRef addLoadedContentDiv_p1,method_ListPage_DPInline_addLoadedContentDiv(me,close)
	End Function
	Public Function addLoadedContentDiv()
		DoAssignmentByRef addLoadedContentDiv,method_ListPage_DPInline_addLoadedContentDiv(me,0)
	End Function
	Public Function getStopLoading()
		DoAssignmentByRef getStopLoading,method_ListPage_DPInline_getStopLoading(me)
	End Function
	Public Function showPage()
		DoAssignmentByRef showPage,method_ListPage_DPInline_showPage(me)
	End Function
	Public Function addCommonHtml()
		DoAssignmentByRef addCommonHtml,method_ListPage_Embed_addCommonHtml(me)
	End Function
...
' serialize stuff
	Public Function ASPserialize
		...
		setArrElement out,"dpParams", dpParams
		setArrElement out,"dpMasterKey", dpMasterKey
		setArrElement out,"masterShortTable", masterShortTable
		setArrElement out,"masterFormName", masterFormName
		setArrElement out,"masterId", masterId
	...
	Public Sub ASPunserialize(dict)
		DoAssignment dpParams, dict("dpParams")
		DoAssignment dpMasterKey, dict("dpMasterKey")
		DoAssignment masterShortTable, dict("masterShortTable")
		DoAssignment masterFormName, dict("masterFormName")
		DoAssignment masterId, dict("masterId")
...
' end serialize
End Class
' ListPage_DPInline implementation 
Function method_ListPage_DPInline_ListPage_DPInline(byref this_object,ByRef params)
	this_object.dpParams = ""
	doClassAssignment this_object,"dpMasterKey",CreateDictionary()
	this_object.masterShortTable = ""
	this_object.masterFormName = ""
	this_object.masterId = ""
	...
	this_object.initDPInlineParams 
	this_object.searchClauseObj.clearSearch 
	setArrElementN this_object.jsSettings,CreateArray3("tableSettings",this_object.tName,"mainMPageType"),this_object.mainMasterPageType
	setArrElementN this_object.jsSettings,CreateArray3("tableSettings",this_object.tName,"masterPageType"),this_object.masterPageType
	setArrElementN this_object.jsSettings,CreateArray3("tableSettings",this_object.tName,"masterTable"),this_object.masterTable
	setArrElementN this_object.jsSettings,CreateArray3("tableSettings",this_object.tName,"firstTime"),this_object.firstTime
	setArrElementN this_object.jsSettings,CreateArray3("tableSettings",this_object.tName,"strKey"),this_object.getStrMasterKey()
End Function
Function method_ListPage_DPInline_initForDetailsPreview(byref this_object)
	if bValue(this_object.firstTime) then
		method_ListPage_DPInline_initForDetailsPreview = ((((((((((((((((((((("Runner.util.ScriptLoader.on('filesLoaded', function(){" & vbcrlf & _
			"						var dpInlObj = window['dpInline" & CSmartStr(this_object.masterId)) & "'];" & vbcrlf & _
			"						dpInlObj.setdpCntParse();" & vbcrlf & _
			"						dpInlObj.initResize(") & CSmartStr(this_object.id)) & ",'") & CSmartStr(jsreplace(this_object.tName))) & "',") & CSmartStr(this_object.firstTime)) & ");" & vbcrlf & _
			"						//init maps object" & vbcrlf & _
			"						if(dpInlObj.prm.mainMPageType!=Runner.pages.constants.PAGE_ADD)" & vbcrlf & _
			"							dpInlObj.initMaps(") & CSmartStr(this_object.id)) & ",'") & CSmartStr(jsreplace(this_object.tName))) & "');" & vbcrlf & _
			"						if(dpInlObj.prm.mainMPageType!=Runner.pages.constants.PAGE_ADD)		" & vbcrlf & _
			"							dpInlObj.preInitMedia('") & CSmartStr(jsreplace(this_object.tName))) & "',") & CSmartStr(this_object.id)) & ",'") & CSmartStr(jsreplace(this_object.masterTable))) & "','") & CSmartStr(this_object.masterPageType)) & "',") & CSmartStr(this_object.masterId)) & ");" & vbcrlf & _
			"					}, this, {single: true});"
		Exit Function
	end if
End Function
Function method_ListPage_DPInline_addButtonHandlers(byref this_object)
End Function
Function method_ListPage_DPInline_importLinksAttrs(byref this_object)
	method_ListPage_DPInline_importLinksAttrs = true
	Exit Function
End Function
Function method_ListPage_DPInline_displayMasterTableInfo(byref this_object)
	method_ListPage_DPInline_displayMasterTableInfo = true
	Exit Function
End Function
Function method_ListPage_DPInline_processMasterKeyValue(byref this_object)
	Dim i
	method_ListPage_processMasterKeyValue this_object
	i = 1
	do while IsLessOrEqual(i,asp_count(this_object.masterKeysReq))
		setArrElement this_object.dpMasterKey,asp_count(this_object.dpMasterKey),ArrayElement(this_object.masterKeysReq,i)
		i = CSmartDbl(i)+1
	loop
End Function
Function method_ListPage_DPInline_initDPInlineParams(byref this_object)
	Dim strkey,i
	strkey = ""
	i = 0
	do while IsLess(i,asp_count(this_object.dpMasterKey))
		strkey = CSmartStr(strkey) & ((("&masterkey" & CSmartStr(CSmartDbl(i)+1)) & "=") & CSmartStr(asp_rawurlencode(ArrayElement(this_object.dpMasterKey,i))))
		i = CSmartDbl(i)+1
	loop
	this_object.dpParams = (((((("mode=listdetails&id=" & CSmartStr(this_object.id)) & "&mastertable=") & CSmartStr(asp_rawurlencode(this_object.masterTable))) & CSmartStr(strkey)) & CSmartStr(IIF(this_object.masterId,"&masterid=" & CSmartStr(this_object.masterId),""))) & CSmartStr(IIF(IsEqual(this_object.masterPageType,PAGE_EDIT) or IsEqual(this_object.masterPageType,PAGE_VIEW),"&masterpagetype=" & CSmartStr(this_object.masterPageType),""))) & CSmartStr(IIF(IsEqual(this_object.mainMasterPageType,PAGE_VIEW),"&mainmasterpagetype=" & CSmartStr(this_object.mainMasterPageType),""))
End Function
Function method_ListPage_DPInline_getStrMasterKey(byref this_object)
	Dim strkey,i
	Set strkey = (CreateDictionary())
	i = 0
	do while IsLess(i,asp_count(this_object.dpMasterKey))
		setArrElement strkey,i,ArrayElement(this_object.dpMasterKey,i)
		i = CSmartDbl(i)+1
	loop
	doAssignmentByRef method_ListPage_DPInline_getStrMasterKey,strkey
	Exit Function
End Function
Function method_ListPage_DPInline_setLinksAttr(byref this_object,ByVal field,ByVal sort)
	Dim href,orderlinkattrs,this
	if not IsEqual(this_object.masterPageType,PAGE_ADD) then
		href = ((((CSmartStr(this_object.shortTableName) & "_list.asp?orderby=") & CSmartStr(IIF(not IsEqual(sort,""),IIF(IsEqual(sort,"a"),"d","a"),"a"))) & CSmartStr(field)) & "&") & CSmartStr(this_object.dpParams)
		orderlinkattrs = ((("href=""" & CSmartStr(href)) & """ onclick=""") & CSmartStr(this_object.getLocation_p1(href))) & """"
		doAssignmentByRef method_ListPage_DPInline_setLinksAttr,orderlinkattrs
		Exit Function
	end if
End Function
Function method_ListPage_DPInline_getLocation(byref this_object,ByVal href,ByVal ret)
	Dim this
	method_ListPage_DPInline_getLocation = ((((("window.frames['flyframe" & CSmartStr(this_object.id)) & "'].location='") & CSmartStr(href)) & "'; ") & CSmartStr(this_object.addRunLoading())) & CSmartStr(IIF(ret," return false;",""))
	Exit Function
End Function
Function method_ListPage_DPInline_inlineAddLinksAttrs(byref this_object)
	if not IsEqual(this_object.masterPageType,PAGE_VIEW) and not IsEqual(this_object.mainMasterPageType,PAGE_VIEW) then
		method_ListPage_inlineAddLinksAttrs this_object
	end if
End Function
Function method_ListPage_DPInline_commonAssign(byref this_object)
	Dim this,searchPermis,editPermis,i,permis
	method_ListPage_Embed_commonAssign this_object
	this_object.xt.assign_p2 "left_block",false
	if (IsEqual(this_object.masterPageType,PAGE_ADD) or IsEqual(this_object.masterPageType,PAGE_VIEW)) or IsEqual(this_object.mainMasterPageType,PAGE_VIEW) then
		this_object.xt.assign_p2 "selectall_link",false
		this_object.xt.assign_p2 "checkbox_column",false
		this_object.xt.assign_p2 "checkbox_header",false
		this_object.xt.assign_p2 "editselected_link",false
		this_object.xt.assign_p2 "delete_link",false
		this_object.xt.assign_p2 "saveall_link",false
		if IsEqual(this_object.masterPageType,PAGE_VIEW) or IsEqual(this_object.mainMasterPageType,PAGE_VIEW) then
			this_object.xt.assign_p2 "recordcontrols_block",false
		end if
	else
		...
		if not IsEqual(this_object.masterPageType,PAGE_EDIT) then
	...
	if not IsEqual(this_object.masterPageType,PAGE_VIEW) and not IsEqual(this_object.mainMasterPageType,PAGE_VIEW) then
		...
		this_object.assignListIconsColumn_p1 editPermis
	...
	loop
End Function
Function method_ListPage_DPInline_deleteSelectedAttrs(byref this_object)
	this_object.xt.assign_p2 "deleteselectedlink_attrs",((((((("name=""delete_selected" & CSmartStr(this_object.id)) & """ id=""delete_selected") & CSmartStr(this_object.id)) & """  " & vbcrlf & _
		"							onclick=""window['dpInline") & CSmartStr(IIF(this_object.masterId,this_object.masterId,this_object.id))) & "'].submitPreviewForm(") & CSmartStr(IIF(this_object.masterId,this_object.id,""))) & ")"""
End Function
Function method_ListPage_DPInline_displayAfterLoadTempl(byref this_object)
	method_ListPage_Embed_displayAfterLoadTempl this_object
	if (not IsEqual(this_object.masterPageType,PAGE_EDIT) and not IsEqual(this_object.masterPageType,PAGE_ADD)) and not IsEqual(this_object.masterPageType,PAGE_VIEW) then
		ResponseWrite ("<div id=""dpRecords" & CSmartStr(this_object.id)) & """ style=""padding-top:2px;white-space: nowrap;"">&nbsp;&nbsp;&nbsp;&nbsp;"
		this_object.xt.display_loaded_p1 "details_block"
		ResponseWrite "&nbsp;&nbsp;"
		this_object.xt.display_loaded_p1 "pages_block"
		ResponseWrite "</div>"
	end if
	ResponseWrite "<div style=""margin:10px 0;"">"
	this_object.xt.display_loaded_p1 "newrecord_controls"
	this_object.xt.display_loaded_p1 "record_controls"
	ResponseWrite "</div>"
	this_object.xt.display_loaded_p1 "grid_block"
	this_object.xt.display_loaded_p1 "pagination_block"
End Function
Function method_ListPage_DPInline_prepareForBuildPage(byref this_object)
	Dim this
...
End Function
Function method_ListPage_DPInline_addLoadedContentDiv(byref this_object,ByVal close)
	Dim cl
	cl = ("<div id = ""loaded_content" & CSmartStr(this_object.id)) & """ "
	if not bValue(this_object.listAjax) then
		cl = CSmartStr(cl) & "name=""loadedContent"" "
	end if
	if (not IsEqual(this_object.masterPageType,PAGE_EDIT) and not IsEqual(this_object.masterPageType,PAGE_ADD)) and not IsEqual(this_object.masterPageType,PAGE_VIEW) then
		cl = CSmartStr(cl) & "style=""position:absolute; left:-10000px;"" "
	end if
	cl = CSmartStr(cl) & ">"
	if bValue(close) then
		cl = CSmartStr(cl) & "</div>"
	end if
	doAssignmentByRef method_ListPage_DPInline_addLoadedContentDiv,cl
	Exit Function
End Function
Function method_ListPage_DPInline_getStopLoading(byref this_object)
	method_ListPage_DPInline_getStopLoading = ((("stopLoading(" & CSmartStr(this_object.id)) & ",") & CSmartStr(this_object.mode)) & ");"
	Exit Function
End Function
Function method_ListPage_DPInline_showPage(byref this_object)
	Dim this,jsfiles,jscode,contents
	this_object.BeforeShowList 
	doAssignmentByRef jsfiles,this_object.PrepareJs()
	jscode = ""
	this_object.fillSetCntrlMaps 
	if IsEqual(this_object.masterPageType,PAGE_LIST) or not IsEqual(this_object.masterPageType,PAGE_LIST) and not bValue(this_object.firstTime) then
		jscode = ("var dpControls = '" & CSmartStr(jsreplace(my_json_encode(this_object.controlsHTMLMap)))) & "';" & vbcrlf & _
			"						dpCntParse = JSON.parse(dpControls);"
	end if
	if bValue(this_object.firstTime) then
		if IsEqual(this_object.masterPageType,PAGE_LIST) then
			jscode = (((((((" var dpSettings = '" & CSmartStr(jsreplace(my_json_encode(this_object.jsSettings)))) & "';" & vbcrlf & _
				"									var dpSetParse = JSON.parse(dpSettings);") & CSmartStr(jscode)) & "							" & vbcrlf & _
				"									Runner.pages.PageSettings.addSettings('") & CSmartStr(jsreplace(this_object.tName))) & "', dpSetParse);") & CSmartStr(jsfiles)) & CSmartStr(this_object.getStopLoading())
			ResponseWrite ("<jscode>" & CSmartStr(asp_str_replace(CreateDictionary3(Empty,"\",Empty,vbcr,Empty,vblf),CreateDictionary3(Empty,"\\",Empty,"\r",Empty,"\n"),jscode))) & "</jscode>"
		end if
	else
		if not IsEqual(this_object.masterPageType,PAGE_LIST) then
			jscode = ((((((" var dpSettings = '" & CSmartStr(jsreplace(my_json_encode(this_object.jsSettings)))) & "';" & vbcrlf & _
				"							var dpSetParse = JSON.parse(dpSettings);") & CSmartStr(jscode)) & "							" & vbcrlf & _
				"							Runner.pages.PageSettings.addSettings('") & CSmartStr(jsreplace(this_object.tName))) & "', dpSetParse);") & CSmartStr(jscode)
		end if
		ResponseWrite (("<textarea id='data'>decli" & CSmartStr(jscode)) & CSmartStr(IIF(this_object.recordsDeleted,"/del/" & CSmartStr(this_object.recordsDeleted),""))) & "</textarea>"
	end if
	if not bValue(this_object.firstTime) then
		ResponseWrite "<textarea id=""html"">"
	end if
	if bValue(this_object.firstTime) and ((IsEqual(this_object.masterPageType,PAGE_EDIT) or IsEqual(this_object.masterPageType,PAGE_ADD)) or IsEqual(this_object.masterPageType,PAGE_VIEW)) then
		ResponseWrite ((((((((((("<br><div id=""dpShowHide" & CSmartStr(this_object.id)) & """ class=""dpDiv"" onClick = ""dpInline") & CSmartStr(this_object.id)) & ".hideShowDetailPreview(this);"">" & vbcrlf & _
			"						<img id=""dpMinus") & CSmartStr(this_object.id)) & """ class=""dpImg"" border=""0"" src=""include/img/minus.gif"" valign=""middle"" alt=""*"" />" & vbcrlf & _
			"						<a name=""dt") & CSmartStr(this_object.id)) & """ class=""dt"">") & CSmartStr(this_object.strCaption)) & "</a>" & vbcrlf & _
			"					</div>" & vbcrlf & _
			"				<div id=""detailPreview") & CSmartStr(this_object.id)) & """ class=""dpStyle"">"
	else
		if bValue(this_object.firstTime) then
			ResponseWrite this_object.addLoadedContentDiv()
		end if
	end if
	...
	if not bValue(this_object.firstTime) then
		...
		doAssignmentByRef contents,ob_get_contents()
		ob_end_clean 
		ResponseWrite htmlspecialchars(contents)
	else
		this_object.displayAfterLoadTempl 
	end if
	if bValue(this_object.firstTime) and ((IsEqual(this_object.masterPageType,PAGE_EDIT) or IsEqual(this_object.masterPageType,PAGE_ADD)) or IsEqual(this_object.masterPageType,PAGE_VIEW)) then
