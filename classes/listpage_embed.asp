...
Class ListPage_Embed
	...
	Public Function init_ListPage_Embed_p1(ByRef params)
		DoAssignmentByRef init_ListPage_Embed_p1,method_ListPage_Embed_ListPage_Embed(me,params)
	End Function
	...
	Public Function displayAfterLoadTempl()
		DoAssignmentByRef displayAfterLoadTempl,method_ListPage_Embed_displayAfterLoadTempl(me)
	End Function
...
' end serialize
End Class
' ListPage_Embed implementation 
Function method_ListPage_Embed_ListPage_Embed(byref this_object,ByRef params)
...
End Function
Function method_ListPage_Embed_addCommonHtml(byref this_object)
	method_ListPage_addCommonHtml this_object
	this_object.xt.assign_p2 "footer",""
End Function
Function method_ListPage_Embed_commonAssign(byref this_object)
	Dim this
...
End Function
Function method_ListPage_Embed_displayAfterLoadTempl(byref this_object)
	method_ListPage_Embed_displayAfterLoadTempl = CSmartStr(this_object.xt.fetch_loaded_p1("style_block")) & CSmartStr(this_object.xt.fetch_loaded_p1("iestyle_block"))
	Exit Function
End Function
Function method_ListPage_Embed_addWhereWithMasterTable(byref this_object)
	if IsEqual(this_object.masterPageType,PAGE_ADD) then
		method_ListPage_Embed_addWhereWithMasterTable = "1=0"
		Exit Function
	end if
	doAssignmentByRef method_ListPage_Embed_addWhereWithMasterTable,method_ListPage_addWhereWithMasterTable(this_object)
	Exit Function
End Function
%>
